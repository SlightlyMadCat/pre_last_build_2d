...
function OnGUI() {
    ...
    var alm:GameObject = GameObject.Find("altetr");
    var arr:GameObject = alm.Find("longArrow");
   //print("x "+alm.transform.position.x);
    arr.transform.position.x += 0.1;  
    arr.transform.Rotate(Vector3.left * Time.deltaTime*5);
}
